...
#putting code in the textbox
def show_code(): codebox.insert(1.0, code)
  
#coloring then placing each character
def show_answer():
  jx = 0
...
#button that shows code
button = tk.Button(text="generate code", command=show_code)
